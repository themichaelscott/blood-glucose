...
package com.ems.bloodglucose.domain.main.phonelistview;
...
public class PhoneListView extends PhoneListViewBaseRecord {
    ...
    public static final String DROP_VIEW = "DROP VIEW IF EXISTS " + TABLE + ";";
    public static final String CREATE_VIEW = "CREATE VIEW IF NOT EXISTS " + TABLE + " AS SELECT " +
            Individual.FULL_C_ID + " AS " + C_ID + ", " +
            Individual.FULL_C_LAST_NAME + " AS " + C_NAME +
